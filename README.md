...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9481&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/legacy-api-wrap-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `legacy-api-wrap` can be installed with:

```
conda install legacy-api-wrap
```

It is possible to list all of the versions of `legacy-api-wrap` available on your platform with:
